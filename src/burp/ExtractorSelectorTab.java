...
public class ExtractorSelectorTab implements ITab {
	...
	private void addButtonPanel(JPanel pane) {
		...
		debugButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (debugOn) {
					debugButton.setBackground(Color.CYAN);
					debugButton.setForeground(Color.WHITE);
	...
	private void addLabels(JPanel pane) {
		...
		requestLabel.setBorder(BorderFactory.createEmptyBorder(4,4,4,4));
		constraints.gridx = 0;
		constraints.gridy = 0;
		...
		responseLabel.setBorder(BorderFactory.createEmptyBorder(4,4,4,4));
		constraints.gridx = 0;
		constraints.gridy = 2;
		constraints.weighty = 0;
		constraints.fill = GridBagConstraints.HORIZONTAL;
